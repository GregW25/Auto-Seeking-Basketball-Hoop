...
class TrajectoryCalculator(Node):
    ...
    def position_callback(self, msg: PointStamped):
        ...
        # 2. Outlier Gate (High Speed Rejection)
        ...
        # Create weights that grow exponentially for recent points
        # Example: [0.13, 0.22, 0.36, 0.60, 1.0] for 5 points
        ...
        # Gravity-Compensated Fit Z with Weights
