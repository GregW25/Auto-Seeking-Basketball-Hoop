...
def generate_launch_description():
    ...
    # Declare the TransformCubePose node
    transform_cube_pose_node = Node(
        package='planning',  # Replace with your package name where the transform_cube_pose node resides
        executable='transform_cube_pose',
        name='transform_cube_pose',
        output='screen',
    )

    # Declare the IKPlanner node
    ik_planner_node = Node(
        package='planning',  # Replace with your actual package name
        executable='ik',  # This should match the name of the executable for the IK node
        name='ik_planner',
        output='screen',
    )
    ...
    return LaunchDescription([
        #commented out anything not needed
