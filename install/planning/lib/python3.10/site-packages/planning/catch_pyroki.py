...
# Filters (keep minimal, but avoid bogus (0,0,0) and floor hits)
...
class UR7e_Catch_Pyroki_MoveIt(Node):
    ...
    def marker_callback(self, msg: Marker):
        ...
        # De-bounce: ignore repeated same target (prevents repeated planning spam)
        ...
        # Extra safety: wrap goal angles to [-pi, pi]
        ...
        # Plan (non-blocking wait + timeout)
        self.is_busy = True
