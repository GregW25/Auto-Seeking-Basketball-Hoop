...
class Cam2TransformPublisher(Node):
    def __init__(self):
        ...
        # --- Define the Homogeneous Transform G_cam2->cam1 ---
        # Parent Frame: camera1_link
        # Child Frame:  camera2_link
        
        # Example: 5cm X, 15cm Y, 90 degree roll
        # You MUST replace this G matrix with your actual measured transform!
        # R_roll_90: [[1, 0, 0], [0, 0, -1], [0, 1, 0]]
        X_t = 0.0
